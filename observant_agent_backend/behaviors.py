...
class ActionQueue(StateModule):
    ...
    def pop(self, observations):
        ...
        if item == None:
            ...
            # "There may or may not be --more-- prompts now.
            # If there are any, mash through them before continuing."
        ...
        if isinstance(item, bool):
            ...
            # If there is, respond with {y/n} until the questions stop."
            # True indicates "respond with y".
            # False indicates "respond with n".
...
agenda = [
    ...
    checkPath,
    checkUnderfoot,
    # Check the engraving underfoot, verify whether or not you're on ELBERETH
    # ...maybe check for "closed for inventory" and "ad aerarium" too
    advancePrompts,

    # Nothing above this point in the agenda may spend a turn.
    recordingDone,
    # Nothing below this point in the agenda may take a non-turn step.

    fixUrgentProblems,
    # drop your gold if a guard instructs you to
